    ...
    <div class="box">
        <form id="cadastro-form" method="POST">
            ...
            <fieldset>
                ...
                <p>Médico:</p>
                <div>
                    <input type="radio" class="med-check" id="drChiquito" name="medico" value="Dr.Chiquito" required <?php if ($medico === 'Dr.Chiquito') echo 'checked'; ?> />
                    <label class="med" for="drChiquito">Ortopedia - Dr.Chiquito</label><br>
                    <input type="radio" class="med-check" id="drLuciano" name="medico" value="Dr.Luciano" required <?php if ($medico === 'Dr.Luciano') echo 'checked'; ?> />
                    <label class="med" for="drLuciano">Cardiologista - Dr.Luciano</label><br>
                    <input type="radio" class="med-check" id="drGustavo" name="medico" value="Dr.Gustavo" required <?php if ($medico === 'Dr.Gustavo') echo 'checked'; ?> />
                    <label class="med" for="drGustavo">Oftalmologista - Dr.Gustavo</label><br>
                    <input type="radio" class="med-check" id="drPrado" name="medico" value="Dr.Prado" required <?php if ($medico === 'Dr.Prado') echo 'checked'; ?> />
