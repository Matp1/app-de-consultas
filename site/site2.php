            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><a href="editar_usuario.php?id=' . $row["id"] . '" class="btn btn-primary">Editar</a>
                            <a href="excluir_usuario.php?id=' . $row["id"] . '" class="btn btn-danger">Excluir</a></td>';
                        echo "</tr>";
                        $count++;
                    }
                } else {
